...
このアプリケーションは、以下の手順でローカル環境で実行して使用します。

1.  **入力**: 左側のパネルにMarkdownを記述します。
2.  **プレビュー**: 右側のパネルにリアルタイムで結果が表示されます。
3.  **テーマ切り替え**: 右上の太陽/月アイコンをクリックして、ライトモードとダークモードを切り替えます。
4.  **インポート/エクスポート**: 右上のアップロード/ダウンロードアイコンから、ファイルの読み込みと保存ができます。
...
- **学生**: 講義ノートやレポートの作成に。
- **Markdownを手軽に試したい方**: ローカル環境を構築して、すぐにMarkdownを試せる環境として。
